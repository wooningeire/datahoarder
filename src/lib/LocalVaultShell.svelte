<script lang="ts">
import CommandPalette from './local-vault/CommandPalette.svelte';
import EditorPane from './local-vault/EditorPane.svelte';
import PreviewPane from './local-vault/PreviewPane.svelte';
import StatusBanners from './local-vault/StatusBanners.svelte';
import Topbar from './local-vault/Topbar.svelte';
import VaultSidebar from './local-vault/VaultSidebar.svelte';
...
import { buildCommandPaletteItems, filterCommandPaletteItems } from './local-vault/command-palette.js';
import { createCollectionActions } from './local-vault/collection-actions.js';
import {
	getCollectionViewDefaultsKey,
	getCollectionViewSortColumn
} from './local-vault/collection-view.js';
import { createInteractionActions } from './local-vault/interaction-actions.js';
import { createNoteActions } from './local-vault/note-actions.js';
import { createPublishActions } from './local-vault/publish-actions.js';
import {
	getRecentNotePaths,
...
} from './local-vault/stored-notes.js';
import type { CollectionCellEdit } from './local-vault/types.js';
import { createVaultFileActions } from './local-vault/vault-file-actions.js';
import { isNoteTemplatePath } from './note-template.js';
import {
