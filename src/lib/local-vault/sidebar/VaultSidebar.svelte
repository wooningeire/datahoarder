		...
		<div class="vault-main-browser">
			...
			{:else if store.vaultHandle}
				<NoteTree
					...
					moveDisabled={store.loading || store.saving}
					moveDirectoryToDirectory={store.vaultActions.moveDirectoryToDirectory}
					moveFileToDirectory={store.vaultActions.moveFileToDirectory}
